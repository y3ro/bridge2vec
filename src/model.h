...
class Model {
  ...
  public:
    ...
    real negativeSampling(int32_t, std::shared_ptr<Dictionary>, int32_t, real);
    real negativeSampling2(int32_t, std::shared_ptr<Dictionary>, int32_t, real);
    real negativeSampling(int32_t, real);
    real negativeSamplingSynth(int32_t, real);
    ...
    void updateWnoise(const std::vector<int32_t>&, const std::vector<std::vector<int32_t>>&, int32_t, real);
    void updateSynth(const std::vector<int32_t>&, int32_t, real);
    void update(int32_t, std::shared_ptr<Dictionary>, const std::vector<int32_t>&, int32_t, real);
    void update2(int32_t, std::shared_ptr<Dictionary>, const std::vector<int32_t>&, int32_t, real);
