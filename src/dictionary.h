...
struct sim {
  std::vector<int32_t> ortographic;
  std::discrete_distribution<unsigned int> orto_sim;
  std::vector<int32_t> semantic;
  std::vector<int32_t> phonetic;
  std::vector<int32_t> reps;
  std::unordered_map<int32_t, int32_t> custom;
}; 
...
class Dictionary {
  protected:
   ...
   public:
    ...
    sim getWordSimilar(int32_t id) const;
    std::string getWord(int32_t) const;
    const std::vector<int32_t>& getSubwords(int32_t) const;
    const std::vector<int32_t> getSubwords(const std::string&) const;
    const std::vector<int32_t> getSubwordsNoSkip(const std::string&) const;
    void getSubwords(
        const std::string&,
        std::vector<int32_t>&,
        std::vector<std::string>&) const;
    void getSubwordsNoSkip(
        const std::string&,
        std::vector<int32_t>&,
        std::vector<std::string>&) const;
    std::vector<int32_t> getSimilar(int32_t, int);
    std::vector<int32_t> getReps(int32_t, int);
    int32_t getRepSym();
    std::vector<int32_t> getPhonSimilar(int32_t, int);
    void computeSubwords(const std::string&, std::vector<int32_t>&) const;
    void computeSubwordsNoSkip(const std::string&, std::vector<int32_t>&) const;
    void computeSubwords(
        const std::string&,
        std::vector<int32_t>&,
        std::vector<std::string>&) const;
    void computeSubwordsNoSkip(
        const std::string&,
        std::vector<int32_t>&,
        std::vector<std::string>&) const;
    ...
    void readExtraDict(std::istream&);
